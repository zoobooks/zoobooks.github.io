...
function greeter(hour) {
    //if the hour is less than or equal to 11 print the message
    if(hour <= 11){
        console.log("Good Morning!");
    }
    //else its greater than or equal to 12 and also less than or to 16
    else if(hour >= 12&&hour <= 16){
        console.log("Good Afternoon!");
    }
    //if the hour is greater than or equal to 17 and less than or equal to 21 print good evening
